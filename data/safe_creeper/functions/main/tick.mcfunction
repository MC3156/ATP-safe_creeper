...
execute as @e[type=area_effect_cloud] if data entity @s potion_contents.custom_effects[{id:"minecraft:unluck",amplifier:1b}] at @s run function safe_creeper:main/aec_1
execute as @e[type=area_effect_cloud] if data entity @s potion_contents.custom_effects[{id:"minecraft:unluck",amplifier:2b}] at @s run function safe_creeper:main/aec_2
